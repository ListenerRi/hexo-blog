---
title: dde-dock插件开发入门
date: 2019-03-16 12:45:42
categories: linux
tags:
- deepin
- dde-dock
...
最近公司需要补充一些项目的文档，我负责的几个项目中比较有实用价值的是这个 dde-dock 插件的开发入门教程，这里是转载，[原发](https://github.com/linuxdeepin/dde-dock/blob/master/plugins/plugin-guide/plugins-developer-guide.md)在 dde-dock 项目源码中。
...
![central-widget](central-widget.png)
...
![disable-plugin](disable-plugin.png)
...
![applet-widget](applet-widget.png)
